  ...
  return (
    <main className="flex flex-col items-center">
      <article className=" mt-[18px] w-[342px] h-[216px] bg-secondary rounded-xl border-4 border-tertiary flex flex-col items-center justify-around">
        ...
        <p className="font-grotesk font-medium text-body text-primary">nombresesion2a3</p>
      </article>
      <article className=" mt-[18px] w-[342px] text-center">
        <h1 className="font-grotesk font-light text-lg text-tertiary">¿Qué hago ahora?</h1>
        <p className="font-grotesk font-normal text-body text-secondary">Espera a que los invitados hagan sus recomendaciones</p>
        <img
    ...
    <button className="w-[184px] h-[36px] rounded-xl bg-primary font-grotesk font-bold text-label text-secondary">
        INICIAR VOTACION
    </button>
      </article>
    </main>
